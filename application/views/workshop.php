...
<html lang="en">
	<head>
        ...
        <nav class="as-nav as-container">
				<a href=<a href="<?php echo base_url(). 'himatif/itfast_2'?>" class="as-nav__logo"> IT FAST # 2</a>
...
<body>
  ...
  <div class="card-body">
  <form method='post' action='<?php echo base_url(). 'himatif/tambah_aksi_lomba_workshop'; ?>' enctype='multipart/form-data'>
		<table style="margin:20px auto;">
			...
			<!-- <td colspan="2"><p style="font-size:10px;" ><b>Note :</b> Masukan foto KTM kedalam google drive lalu sertakan link google drive didalam form KTM</p></td> -->
			</tr>
