				...
				<div class="row g-5">
					<div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
						...
						<p style="text-align: center;" class="mb-5">
							"Menjadikan Departemen Hubin dan Hubeks yang professional dan efektif dalam berkomunikasi serta meningkatkan kesadaran
						...
						<div class="row gy-5 gx-4">
							...
							<div class="col-sm-6 wow fadeIn" data-wow-delay="0.1s">
								<div class="d-flex align-items-center mb-3">
									...
									<p>
										Membangun hubungan dan menjaga relasi secara baik dan berkesinambungan dengan internal atau eksternal.
									</p>
								</div>
							</div>
							<div class="col-sm-6 wow fadeIn" data-wow-delay="0.2s">
								<div class="d-flex align-items-center mb-3">
									...
									<p class="mb-0">
										Meningkatkan kesadaran dan partisipasi mahasiswa dalam kegiatan kemahasiswaan melalui komunikasi yang efektif.
									</p>
								</div>
							</div>
							<div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
								<div class="d-flex align-items-center mb-3">
									...
									<p>
										Membangun dan memelihara hubungan yang kuat dan berkelanjutan dengan Mahasiswa, Stakeholder, Dosen,
										Ormawa dan masyarakat lainnya.
									</p>
								</div>
							</div>
							<div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
								<div class="d-flex align-items-center mb-3">
									...
									<p>
										Mengembangkan dan melaksanakan program komunikasi yang berfokus pada kepentingan Mahasiswa Teknik Informatika.
									</p>
								</div>
							</div>
						</div>
        ...
        <div class="container">
			...
			<div class="row g-4 justify-content-center">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="courses-item d-flex flex-column bg-white overflow-hidden h-100">
                        <div class="text-center p-4 pt-0">
                            <h5 class="mb-3">HIMATIF GO TO SCHOOL
                            </h5>
                            <p style="text-align: justify;">Meningkatkan kesadaran dan partisipasi mahasiswa dalam kegiatan sosial,
