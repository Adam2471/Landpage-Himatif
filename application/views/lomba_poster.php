...
<body>
  ...
  <div class="card-header" style="text-align: center;">
	...
	<b>Poster Competition</b><p>“Menjadikan Ekonomi Kreatif Sebagai Budaya Bangsa ditengah Kemajuan Teknologi”/p>
  </div>
  <div class="card-body">
  <form method='post' action='<?php echo base_url(). 'himatif/tambah_aksi_lomba_poster'; ?>' enctype='multipart/form-data'>
		<table style="margin:20px auto;">
			...
			<tr>
				<td><input type="hidden" name="lomba" value="poster"></td>
			</tr>
            <tr>
