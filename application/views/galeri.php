...
<body>
    ...
    <div class="galeri-container">
        ...
        <!-- Kegiatan 10 -->
        <div class="kegiatan-box">
            <img src="<?php echo base_url('assets/img/proker/pplkuniv25.jpg'); ?>" alt="pplkuniv">
            <div class="kegiatan-content">
                <div class="kegiatan-title">PPLK Universitas</div>
                <div class="kegiatan-desc">Program pengenalan lingkungan kampus.</div>
                <div class="kegiatan-time">Juli 2025</div>
            </div>
        </div>
