    ...
    <div class="container-xxl py-6">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px">
                <h4 class="display-6 mb-20">Tim MIBA</h4>
                <h6 class="text-primary text-uppercase mb-2"></h6>
            </div>

            <!-- Baris jastin (tengah atas) -->
            ...
            <!-- Baris sejajar bawah -->
            <div class="row justify-content-center"> <!--kunci barisan sejajar-->
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="team-item position-relative">
                        ...
                        <div class="bg-light text-center p-3">
                            <h5 class="mt-2">Fadila Adeliani Putri</h5>
