			...
			<div class="container">
				<div class="row g-5">
					<div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
						<h2 style= "text-align: center;" class="text-dark text-uppercase mb-2">Visi</h2>
						<p style="text-align: center;" class="mb-5">
							"Mewujudkan Himatif sebagai wadah eksplorasi dan pengembangan teknologi yang berkelanjutan bagi mahasiswa Teknik Informatika Universitas Pelita Bangsa"
						</p>
						<div class="row gy-5 gx-4">
							<h2 class="text-dark text-uppercase mb-2 text-center" >Misi</h2>
							<div class="col-sm-6 wow fadeIn" data-wow-delay="0.1s">
								<div class="d-flex align-items-center mb-3">
									...
									<p>
										Membuka ruang eksplorasi teknologi melalui proyek dan diskusi.
									</p>
								</div>
							</div>
							<div class="col-sm-6 wow fadeIn" data-wow-delay="0.2s">
								<div class="d-flex align-items-center mb-3">
									...
									<p class="mb-0">
										Membangun kolaborasi dengan demisioner, pihak prodi, dan praktisi guna memperluas wawasan serta keterampilan teknis.
									</p>
								</div>
							</div>
							<div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
								<div class="d-flex align-items-center mb-3">
									...
									<p>
										Mengadakan kegiatan berbasis praktik seperti konfigurasi jaringan, simulasi server dan implementasi teknologi untuk efisiensi dan inovasi Himatif.
									</p>
								</div>
							</div>
						</div>
                ...
                <div class="team-item position-relative">
                    <div class="position-relative">
                        ...
                        <div class="team-social text-center">
                            ...
                            <a class="btn btn-square btn-outline-primary border-2 m-1" href="https://www.instagram.com/nabillio?igsh=YnJ2M2t3dGFkaG4y">
                    ...
                    <div class="courses-item d-flex flex-column bg-white overflow-hidden h-100 shadow rounded">
                        <div class="text-center p-4 pt-0">
                            ...
                            <p style="text-align: justify;">HimNec (Himatif Network Class) adalah program kerja dari departemen Litbang, 
								program ini menyediakan pembelajaran berbasis praktikum tentang jaringan, 
								baik konfigurasi jaringan maupun simulasi server sehingga memungkinkan mahasiswa/i 
