...
<body>
  ...
  <div class="card-header" style="text-align: center;">
   ...
   <b>UI/UX Competition</b><p>“Implementation of Digital Technologies for Inclusive Future”</p>
  </div>
  <div class="card-body">
  <form method='post' action='<?php echo base_url(). 'himatif/tambah_aksi_lomba_uiux'; ?>' enctype='multipart/form-data'>
		<table style="margin:20px auto;">
			...
			<tr>
				<td><input type="hidden" name="lomba" value="ui/ux"></td>
			</tr>
			<tr>
				<td>&nbsp</td>
			</tr>
