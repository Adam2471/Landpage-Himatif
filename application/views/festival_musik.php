...
<head>
    ...
    <nav class="as-nav as-container">
        <a href="<?php echo base_url() . 'himatif/itfast_2' ?>" class="as-nav__logo"
        >IT FAST # 2
        </a>
        <div class="as-nav__menu" id="nav-menu">
            <ul class="as-nav__list">
                ...
                <li class="as-nav__item">
                    <a href="<?php echo base_url() . 'himatif/itfast_2' ?>" class="as-nav__link"
                    >Lomba</a>
                </li>
                <li class="as-nav__item">
                    <a href="#partner" class="as-nav__link"
                    >Sponsorship</a>
                </li>
                <li class="as-nav__item">
                    <a href="#partner" class="as-nav__link"
    ...
    <div class="row m-0 my-3">
        <div class="col-md-6 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <?php echo form_open_multipart('himatif/festival_musik'); ?>
                    <div class="mb-3 row">
                        <label for="" class="col-md-4 col-form-label">Nama Penanggung Jawab</label>
                        <div class="col-md-8">
                    ...
                    <div class="mb-3 row">
                        <label for="" class="col-md-4 col-form-label">Nama Band atau  Bazar</label>
                        <div class="col-md-8">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                            <select name="lomba" id="" class="form-control">
                                ...
                                <option value="HIFAST">Registrasi Panggung Musik</option>
                                <option value="HIFAST">Registrasi Bazar UMKM</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="" class="col-md-4 col-form-label">Upload Bukti Registrasi</label>
                        <div class="col-md-8">
