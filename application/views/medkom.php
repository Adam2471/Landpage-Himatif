	...
	<body>
				...
				<div class="row g-5">
					<div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
						...
						<p style="text-align: center;" class="mb-5">
							"Menjadikan departemen Medkominfo sebagai departemen yang edukatif, inovatif, komunikatif, informatif serta mempererat hubungan baik
							antar internal dan eksternal Himatif Universitas Pelita Bangsa."
						</p>
						...
						<div class="row gy-5 gx-4">
							...
							<div class="col-sm-6 wow fadeIn" data-wow-delay="0.1s">
								<div class="d-flex align-items-center mb-3">
									...
									<p>
										Memberikan informasi yang aktual, edukatif, dan bermanfaat kepada internal dan eksternal Himatif Universitas Pelita Bangsa.
									</p>
								</div>
							</div>
							<div class="col-sm-6 wow fadeIn" data-wow-delay="0.2s">
								<div class="d-flex align-items-center mb-3">
									...
									<p class="mb-0">
										Menjaga hubungan yang baik antar Divisi dan Ormawa.
									</p>
								</div>
							</div>
							<div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
								<div class="d-flex align-items-center mb-3">
									...
									<p>
										Mendukung semua kegiatan positif yang diselenggarakan Himpunan Mahasiswa Teknik Informatika.
									</p>
								</div>
							</div>
					...
					<div class="col-lg-6 wow fadeInUp" data-wow-delay="0.4s">
						...
						>
							<img
								class="position-absolute w-100 h-50"
								src="<?php base_url() ?>../assets/img/images/dpt/L2.png"
								alt=""
		...
		<div class="container-xxl py-6">
			<div class="container">
				...
				>
					<h4 class="display-6 mb-20">Tim Media Komunikasi dan Informasi</h4>
				...
				<div class="row g-0 team-items">
					...
					<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
						<div class="team-item position-relative">
							<div class="position-relative">
								<img class="img-fluid" src="<?php base_url() ?>../assets/img/pengurus/wanda.jpg" alt="" />
							...
							<div class="bg-light text-center p-3">
								<h5 class="mt-2">Roswanda Nuraini</h5>
					...
					<div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
						<div class="team-item position-relative">
							<div class="position-relative">
								<img
									class="img-fluid"
									src="<?php base_url() ?>../assets/img/pengurus/rafi.jpg"
									alt=""
								/>
								<div class="team-social text-center">
									<a
							...
							<div class="bg-light text-center p-3">
								<h5 class="mt-2">Rafi Suswidia</h5>
					...
					<div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.8s">
						<div class="team-item position-relative">
							...
							<div class="bg-light text-center p-3">
								<h5 class="mt-2">Irfan Gunawan Pratama</h5>
				...
				<!-- <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="courses-item d-flex flex-column bg-white overflow-hidden h-200">
                        <div class="text-center p-4 pt-0">
                            ...
                            <p style="text-align: justify;">Acara sharing antara pengisi materi dengan mahasiswa yang bertujuan untuk mengkaji isu isu keilmuan tentang informatika. Seminar Nasional ini akan diselenggarakan bersamaan dengan program kerja Dept. Miba yaitu FAST UPB 2022.
								
							</p>
                            <ol class="breadcrumb justify-content-center mb-0">
                            
                                <li class="breadcrumb-item small"><i class="fa fa-calendar-alt text-primary me-2"></i>September 2022</li>
                            </ol>
                        </div>
                        <div class="position-relative mt-auto">
                            <img class="img-fluid" src="<?php base_url() ?>../assets/img/proker/semnas.png" alt="">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="courses-item d-flex flex-column bg-white overflow-hidden h-200">
                        <div class="text-center p-4 pt-0">
                            ...
                            <h5 class="mb-3">Lomba Poster</h5>
                            <p style="text-align: justify;">Lomba Poster adalah sebuah rencana kegiatan sebagai Ajang kompetisi bagi mahasiswa Teknik informatika dalam membuat sebuah karya kreatif berbentuk poster. Kegiatan ini berkolaborasi bersama Dept. </p>
                            <ol class="breadcrumb justify-content-center mb-0">
                                
                                <li class="breadcrumb-item small"><i class="fa fa-calendar-alt text-primary me-2"></i>17 Agustus 2022</li>
                            </ol>
                        </div>
                        <div class="position-relative mt-auto">
                            <img class="img-fluid" src="<?php base_url() ?>../assets/img/proker/poster.png" alt="">
                            <div class="courses-overlay">
                                <a class="btn btn-outline-primary border-2" href="">Read More</a>
                            </div>
                        </div>
