			...
			<div class="navbar-nav ms-auto p-4 p-lg-0">
				...
				<div class="nav-item dropdown">
					...
					<div class="dropdown-menu bg-light m-0">
						...
						<a href="<?php echo base_url() ?>himatif/ksb" class="dropdown-item" style="text-transform: capitalize;">Pengurus Inti</a>
						<a href="<?php echo base_url() ?>himatif/po" class="dropdown-item" style="text-transform: capitalize;">Pengembangan Organisasi</a>
						<a href="<?php echo base_url() ?>himatif/medkom" class="dropdown-item" style="text-transform: capitalize;">Media Komunikasi dan Informasi</a>
						<a href="<?php echo base_url() ?>himatif/miba" class="dropdown-item" style="text-transform: capitalize;">Minat dan Bakat</a>
						<a href="<?php echo base_url() ?>himatif/litbang" class="dropdown-item" style="text-transform: capitalize;">Penelitan dan Pengembangan</a>
				...
				<a href="<?php echo base_url() ?>himatif/galeri" class="nav-item nav-link" style="text-transform: capitalize;">Galeri</a>
				<div class="nav-item dropdown">
					<a href="#" class="nav-link dropdown-toggle" style="text-transform: capitalize;" data-bs-toggle="dropdown">Event</a>
					<div class="dropdown-menu bg-light m-0">
						<a href="<?php echo base_url() ?>himatif/itfast_2" class="dropdown-item" style="text-transform: capitalize;">IT FAST</a>
