<!-- Footer Start -->
<div class="container-fluid bg-dark text-light footer my-6 mb-0 py-6 wow fadeIn"
			data-wow-delay="0.1s">
			<div class="container">
				<div class="row g-7">
					<div class="col-lg-4 col-md-6">
						...
						<p class="mb-2">
							<i class="fa fa-map-marker-alt me-3"></i>Jl. Inspeksi Kalimalang No.9, Cibatu, Cikarang Sel., Kabupaten Bekasi, Jawa Barat 17530
						</p>
						<p class="mb-2">
							<i class="fa fa-phone-alt me-3"></i>089631149187
						<p class="mb-2">
							<i class="fa fa-envelope me-3"></i>himatif@pelitabangsa.ac.id
						</p>
					</div>
			...
			<div class="">
				<div class="row">
					<div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
						&copy; <a href="#">HIMATIF-Univ.Pelita Bangsa</a>
					</div>
