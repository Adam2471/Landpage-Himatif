...
<body>
  ...
  <div class="card-header" style="text-align: center;">
	<b>Internet Of Things(IOT) Competition</b><p>“Internet of Things for create smart innovation in the economic”</p>
  </div>
  <div class="card-body">
  <form method='post' action='<?php echo base_url(). 'himatif/tambah_aksi_lomba_iot'; ?>' enctype='multipart/form-data'>
		<table style="margin:20px auto;">
			...
			<tr>
				<td><input type="hidden" name="lomba" value="iot"></td>
			</tr>
			<tr>
				<td>&nbsp</td>
			</tr>
