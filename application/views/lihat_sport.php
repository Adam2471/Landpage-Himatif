...
<table class="table mt-3">
  <thead>
    <tr>
      <th scope="col">No</th>
      <th scope="col">Nama LO(Liaison Officer)</th>
      <th scope="col">Nama Band dan Genre Musik</th>
      <th scope="col">No HP</th>
      <th scope="col">Jenis Produk (Bazar)</th>
  ...
  ?>
    <tr>
      ...
      <td><?php echo anchor('admin/hapus_sport/'.$p->id,'Hapus') ?></td>
    </tr>
    <?php } ?>
  </tbody>
</table>
